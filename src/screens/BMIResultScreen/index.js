...
//               {[
//                 ...Array(10).fill("#4DB5FF"),   // Blue (Underweight)
//                 ...Array(15).fill("#50C878"),   // Green (Normal)
//                 ...Array(15).fill("#FFD93D"),   // Yellow (Overweight)
//                 ...Array(15).fill("#FF6B6B"),   // Red (Obesity)
//               ].map((color, index) => (
//                 <View
//                   key={index}
//                   style={[styles.scaleBar, { backgroundColor: color }]}
//                 />
//               ))}
//             </View>
